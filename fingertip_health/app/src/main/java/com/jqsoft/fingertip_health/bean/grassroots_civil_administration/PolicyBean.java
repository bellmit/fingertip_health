...
public class PolicyBean implements Serializable {
    ...
    public PolicyBean(String id, String releaseTime, String title, String author, String message, String messageFirstImgSrc, String picture, String type,String areaLevel) {
        this.id = id;
