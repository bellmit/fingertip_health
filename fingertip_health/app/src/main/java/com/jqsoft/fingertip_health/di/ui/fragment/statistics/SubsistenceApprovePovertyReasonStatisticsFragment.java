...
import com.jqsoft.fingertip_health.adapter.statistics.SubsistenceApprovePovertyReasonStatisticsAdapter;
...
import com.jqsoft.fingertip_health.di.presenter.SubsistenceApprovePovertyReasonStatisticsFragmentPresenter;
...
//        l.setWordWrapEnabled(true);
    ...
    private void setPieChartData(List<SubsistenceApprovePovertyReasonNaturalBean> beanList){
        ...
        for (int i = 0; i < beanList.size() ; i++) {
            SubsistenceApprovePovertyReasonNaturalBean bean = beanList.get(i);
            ...
            if (ListUtils.isEmpty(rawList)){
                return resultList;
                    ...
                    for (int j = 0; j < rawList.size(); ++j) {
                        ...
                        nb.setHouseholdNumber(Util.getCommaSeparatedIntString(Util.getForcedIntStringFromDoubleString(b.getValue())));
