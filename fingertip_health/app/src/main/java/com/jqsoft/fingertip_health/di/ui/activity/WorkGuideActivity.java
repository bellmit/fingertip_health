...
import com.jqsoft.fingertip_health.adapter.LeftListAdapter;
import com.jqsoft.fingertip_health.adapter.MainSectionedAdapter;
...
import com.jqsoft.fingertip_health.view.PinnedHeaderListView;
...
/*
    ...
    protected void initView() {
     ...
     //   pop.show();
//        gdws_sys_area citylist=pop.getCitylist();
...
//
//
//            allcityList = DataSupport.where(" areaLevel=?  and areaName=? ","area_2","合肥市").find(gdws_sys_area.class);
//            allcityList2 = DataSupport.where(" areaLevel=? ","area_3" ).find(gdws_sys_area.class);
//            allcityList3 = DataSupport.where(" areaLevel=? ","area_4" ).find(gdws_sys_area.class);
//
//        }else {
//
//
//            allcityList = DataSupport.where(" areaLevel=?  and areaName=? ","area_2", citylist.getAreaName()).find(gdws_sys_area.class);
//            allcityList2 = DataSupport.where(" areaLevel=? ","area_3" ).find(gdws_sys_area.class);
//            allcityList3 = DataSupport.where(" areaLevel=? ","area_4" ).find(gdws_sys_area.class);
//
//
//        }
        ...
        allcityList = DataSupport.where(" areaLevel=?  and state=?","area_1","0").find(SRCLoginAreaBean.class);
        allcityList2 = DataSupport.where(" areaLevel=?  and state=?","area_2" ,"0").find(SRCLoginAreaBean.class);
        allcityList3 = DataSupport.where(" areaLevel=? and state=? ","area_3" ,"0").find(SRCLoginAreaBean.class);
...
//                Toast.makeText(getApplicationContext(),"点击了"+rightStr[section][position], Toast.LENGTH_SHORT).show();
                ...
                List<SRCLoginAreaBean>  checkcity = DataSupport.where(" areaName=? and state=?", rightStr[section][position] ,"0").find(SRCLoginAreaBean.class);
