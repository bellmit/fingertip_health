...
import com.jqsoft.fingertip_health.adapter.statistics.SubsistenceStandardRankingStatisticsAdapter;
...
import com.jqsoft.fingertip_health.di.presenter.SubsistenceStandardRankingStatisticsFragmentPresenter;
...
public class SubsistenceStandardRankingStatisticsFragment extends AbstractFragment implements SubsistenceStandardRankingStatisticsFragmentContract.View, IUpLevel {
...
//        initSupportType(supportTypeIndex);
        RxView.clicks(tvSupportType)
                ...
                .subscribe(new Observer<Object>() {
                    ...
                    @Override
                    public void onNext(Object o) {
                        String[] typeArray = new String[]{"农村特困集中供养", "农村特困分散供养", "城市特困集中供养", "城市特困分散供养"};
                        List<String> typeList = Arrays.asList(typeArray);
