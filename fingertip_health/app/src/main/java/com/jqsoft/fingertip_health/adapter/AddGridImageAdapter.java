...
//                            }
                ...
                case 2:
                    ...
                    String FIND_FILE_URL_BASE = golbIp;
                    String ultimatePath = FIND_FILE_URL_BASE +  (!StringUtils.isBlank(url) ? url : Constants.EMPTY_STRING);

//                    String ultimatePath = path;
//                    if (StringUtils.isBlank(ultimatePath)){
//                        ultimatePath = videoUrl;
//                    }

                    Log.i("时长:", media.getDuration() + "");
                    Glide.with(viewHolder.itemView.getContext()).load(ultimatePath).thumbnail(0.5f)
                            .placeholder(R.mipmap.g_placeholder)
                            .into(viewHolder.mImg);
