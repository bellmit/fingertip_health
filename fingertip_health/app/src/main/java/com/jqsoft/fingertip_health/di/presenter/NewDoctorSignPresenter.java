...
public class NewDoctorSignPresenter implements NewDoctorSignContractForFingertip.presenter {

    private final NewDoctorSignContractForFingertip.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public NewDoctorSignPresenter(NewDoctorSignContractForFingertip.View view,
    ...
    public void main(Map<String, String> map) {
        ...
        if (!Util.isNetworkConnected(context)) {
            view.onSubmitInfoFailure(Constants.HINT_LOADING_DATA_FAILURE);
            return;
        }
...
//                        });
                    ...
                    public void onError(Throwable e) {
                        Util.hideGifProgressDialog(context);
                        view.onSubmitInfoFailure(e.getMessage());
