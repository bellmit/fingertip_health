...
public class RecipeFragmentPresenter implements RecipeFragmentContract.presenter {

    private final RecipeFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public RecipeFragmentPresenter(RecipeFragmentContract.View view,
        ...
        GCAService.queryRecipe(body)
                ...
                .subscribe(new Subscriber<HttpResultBaseBeanForFingertip<String>>() {
                    ...
                    public void onError(Throwable e) {
                        Util.hideGifProgressDialog(context);
                        view.onRecipeFailure(e.getMessage());
                    }
