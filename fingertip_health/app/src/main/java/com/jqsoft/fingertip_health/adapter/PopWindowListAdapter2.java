...
public class PopWindowListAdapter2 extends BaseAdapter {
    private Context context;
    private ArrayList<DrugInfo> reslist = new ArrayList<>();

    public PopWindowListAdapter2(Context context, ArrayList<DrugInfo> reslist) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.btn_jia=(Button)convertView.findViewById(R.id.btn_jia) ;
