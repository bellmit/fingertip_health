...
public class HighBloodListActivityPresenter implements HighBloodListActivityContract.presenter {

    private final HighBloodListActivityContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public HighBloodListActivityPresenter(HighBloodListActivityContract.View view,
