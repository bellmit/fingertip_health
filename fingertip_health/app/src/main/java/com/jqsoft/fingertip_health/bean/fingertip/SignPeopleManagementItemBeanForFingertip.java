...
public class SignPeopleManagementItemBeanForFingertip {
    ...
    public SignPeopleManagementItemBeanForFingertip() {
        super();
    }

    public SignPeopleManagementItemBeanForFingertip(String id, String sexCode, String sexName, String name, String birthday, String areaFulladdress, String nationCode, String nationName, String areaHouseno, String idNo, String phone, String residentType, String hujiType, String areavillageCode, String age) {
        this.id = id;
