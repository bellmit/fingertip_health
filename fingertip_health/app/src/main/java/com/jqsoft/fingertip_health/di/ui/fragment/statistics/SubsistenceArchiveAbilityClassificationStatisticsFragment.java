...
import com.jqsoft.fingertip_health.adapter.statistics.SubsistenceArchiveAbilityClassificationStatisticsAdapter;
...
import com.jqsoft.fingertip_health.di.presenter.SubsistenceArchiveAbilityClassificationStatisticsFragmentPresenter;
...
//        l.setWordWrapEnabled(true);
    ...
    private void setPieChartData(List<NameValueBean> beanList){
        ...
        try {
            if (ListUtils.isEmpty(rawList)){
                ...
                for (int i = 0; i < rawList.size(); ++i){
                    NameValueBean nvb = rawList.get(i);
