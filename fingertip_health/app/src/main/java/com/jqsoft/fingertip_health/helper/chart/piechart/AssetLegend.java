...
public class AssetLegend extends View {
    ...
    public AssetLegend(Context context) {
        super(context);
    }

    public AssetLegend(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    public AssetLegend(Context context, AttributeSet attrs, int defStyleAttr) {
