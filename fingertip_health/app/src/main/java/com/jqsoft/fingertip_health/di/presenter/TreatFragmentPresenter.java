...
public class TreatFragmentPresenter implements TreatFragmentContract.presenter {

    private final TreatFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public TreatFragmentPresenter(TreatFragmentContract.View view,
        ...
        GCAService.queryTreat(body)
                ...
                .subscribe(new Subscriber<HttpResultBaseBeanForFingertip<String>>() {
                    ...
                    public void onError(Throwable e) {
                        Util.hideGifProgressDialog(context);
                        view.onTreatFailure(e.getMessage());
                    }
