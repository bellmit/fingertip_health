...
import com.jqsoft.fingertip_health.adapter.NewsNotificationFragmentSubAdapterForFingertip;
...
public class NewsNotificationFragmentForFingertip extends AbstractFragment {
    ...
    NewsNotificationFragmentSubAdapterForFingertip mAdapter;

    public NewsNotificationFragmentForFingertip() {
    }
    ...
    protected void initView() {
        ...
        final BaseQuickAdapter<TodoSubItemBean, BaseViewHolder> mAdapter = new NewsNotificationFragmentSubAdapterForFingertip(
                new ArrayList<TodoSubItemBean>());
        this.mAdapter = (NewsNotificationFragmentSubAdapterForFingertip) mAdapter;
