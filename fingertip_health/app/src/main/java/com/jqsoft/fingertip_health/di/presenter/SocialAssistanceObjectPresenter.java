...
//        ultimateMap.put(Constants.REQUEST_KEY, jsonString);
        ...
        signedResidentClientService.getSocialObjectData(map)
                .compose(abstractActivity.<GCAHttpResultBaseBean<List<SocialAssistanceObjectBean>>>bindToLifecycle())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
//                .subscribe(new Subscriber<GCAHttpResultBaseBean<TreatmentListResultWrapperBean>>() {
                 .subscribe(new BaseSubscriber<GCAHttpResultBaseBean<List<SocialAssistanceObjectBean>>>(context) {
                        @Override
                    public void onStart() {
                        super.onStart();
...
//                        }
                    ...
                    @Override
                    public void onNext(GCAHttpResultBaseBean<List<SocialAssistanceObjectBean>> bean) {
