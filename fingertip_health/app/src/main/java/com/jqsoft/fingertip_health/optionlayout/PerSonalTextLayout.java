...
public class PerSonalTextLayout extends LinearLayout {
    ...
    public PerSonalTextLayout(Context context, NameValueBean bean, boolean isSingleSelect) {
        super(context);
        this.bean = bean;
    ...
    public PerSonalTextLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
