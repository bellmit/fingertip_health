...
public class DetailPeopleInfoActivityPresenter implements DetailPeopleInfoContract.presenter {

    private final DetailPeopleInfoContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public DetailPeopleInfoActivityPresenter(DetailPeopleInfoContract.View view,
