...
public class PatientListDialogPresenter implements PatientListDialogContractForFingertip.presenter {

    private final PatientListDialogContractForFingertip.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public PatientListDialogPresenter(PatientListDialogContractForFingertip.View view,
    ...
    public void main(Map<String, String> map) {
        ...
        if (!Util.isNetworkConnected(context)) {
            view.onLoadPatientListInfoFailure(Constants.HINT_LOADING_DATA_FAILURE);
            return;
        }
...
//                        });
                    ...
                    public void onError(Throwable e) {
                        Util.hideGifProgressDialog(context);
                        view.onLoadPatientListInfoFailure(e.getMessage());
...
//                        }
                    ...
                    public void onNext(HttpResultBaseBeanForFingertip<String> bean) {
                        ...
                        if (isSuccessful) {
                            view.onLoadPatientListInfoSuccess(bean);
                            ...
                            view.onLoadPatientListInfoFailure(msg);
                        }
