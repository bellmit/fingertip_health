...
//        Util.setChartSpecificAxisMinimumMaximum(lcChart.getAxisLeft(), leftList, 0.1f);
//        Util.setChartSpecificAxisMinimumMaximum(lcChart.getAxisRight(), rightList, 0.1f);
        Util.setChartSpecificAxisMinimumMaximum(lcChart.getAxisLeft(), leftList, Constants.CHART_RANGE_EXTRA_SPACE_PERCENT_FIRST);
        Util.setChartSpecificAxisMinimumMaximum(lcChart.getAxisRight(), rightList, Constants.CHART_RANGE_EXTRA_SPACE_PERCENT_SECOND);

        if (!Constants.MEDICAL_ASSISTANT_FINANCE_ASSURANCE_INCREASE_RATIO_VALUE.equals(type)){
            lcChart.getAxisLeft().setTextColor(Constants.CHART_FIRST_COLOR);
            lcChart.getAxisRight().setTextColor(Constants.CHART_SECOND_COLOR);
        }
