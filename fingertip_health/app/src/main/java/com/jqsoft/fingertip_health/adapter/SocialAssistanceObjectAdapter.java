...
public class SocialAssistanceObjectAdapter extends BaseQuickAdapterEx<SocialAssistanceObjectBean, BaseViewHolder> {
    private Context context;

    public SocialAssistanceObjectAdapter(List<SocialAssistanceObjectBean> data, Context context) {
    ...
    @Override
    protected void convert(final BaseViewHolder helper, final SocialAssistanceObjectBean item) {
