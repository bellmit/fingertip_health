...
public class DmFragmentPresenter implements DmFragmentContract.presenter {

    private final DmFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public DmFragmentPresenter(DmFragmentContract.View view,
    ...
    public void postdate(Map<String, String> map){
        ...
        GCAService.postiabetesMeli(body)
