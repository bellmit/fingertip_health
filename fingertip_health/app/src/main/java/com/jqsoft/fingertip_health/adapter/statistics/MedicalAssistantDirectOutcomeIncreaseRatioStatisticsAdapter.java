...
public class MedicalAssistantDirectOutcomeIncreaseRatioStatisticsAdapter extends BaseQuickAdapterEx<MedicalAssistantDirectOutcomeBean, BaseViewHolder> {
    private String type;
    public MedicalAssistantDirectOutcomeIncreaseRatioStatisticsAdapter(String type, List<MedicalAssistantDirectOutcomeBean> data) {
        super(R.layout.item_medical_assistant_direct_outcome_increase_ratio_5_column_statistics_layout, data);
