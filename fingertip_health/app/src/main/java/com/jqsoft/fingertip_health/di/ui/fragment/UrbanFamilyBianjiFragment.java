...
import com.jqsoft.fingertip_health.adapter.UrbanLowFamilyAdapter;
      ...
      /*  String s2=mybatchno;
        ...
        fab_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String sarealeavel= IdentityManager.getAreaLevel(getActivity());
                ...
                if(sarealeavel.equals("area_4") || sarealeavel.equals("area_5")){
                    ...
                    Toast.makeText(getActivity(),"您没有权限进行新增家庭成员信息!",Toast.LENGTH_SHORT).show();
                }
