...
public class HarbelFragmentPresenter implements HarbelFragmentContract.presenter {

    private final HarbelFragmentContract.View view;
    private final SharedPreferences sharedPreferences;
    private final GCAService GCAService;


    @Inject
    public HarbelFragmentPresenter(HarbelFragmentContract.View view,
        ...
        GCAService.queryharbel(body)
                ...
                .subscribe(new Subscriber<HttpResultBaseBeanForFingertip<String>>() {
                    ...
                    public void onError(Throwable e) {
                        Util.hideGifProgressDialog(context);
                        view.onHarbelFailure(e.getMessage());
                    }
